(function () {
  window.LOCALITICS_CONFIG.DATA_POINTS = {
    hotnessIndex: {
      name: 'Hotness Index',
      formula: function (params) {
        return params.search_count;
      }
    },
    liquidityIndex: {
      name: 'Liquidity Index',
      formula: function (params) {
        var val = params.empty_bed_count;
